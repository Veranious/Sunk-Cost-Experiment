...
for trialNum = 1:MaxTrials
    ...
    sma = AddState(sma,'Name','NewOfferTone',...
        ...
        'OutputActions',{'SoftCode',2,'PWM3',255});   % distinct "new offer" tone
    sma = AddState(sma,'Name','DecreaseNew',...
        'Timer',0.1,...
        'StateChangeConditions',{'Tup','WaitingForRewardNew',...
                                 'Port3Out','GracePeriod3'},...
        'OutputActions',{'SoftCode',4,'GlobalTimerTrig',2,'PWM3',255});
    ...
    sma = AddState(sma,'Name','RewardDelivery',...
        ...
        'OutputActions',{'Valve3',1,'SoftCode',5});
    ...
    sma = AddState(sma,'Name','RejectOffer',...
        'Timer',2,...
        'StateChangeConditions',{'Tup','ITI'},...
        'OutputActions',{'PWM2',255,'SoftCode',6}); %%reject tone
    ...
    sma = AddState(sma,'Name','ITI',...
        ...
        'OutputActions',{'SoftCode',7}); %%reset tones safe guard
